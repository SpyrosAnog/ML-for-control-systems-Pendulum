...
MODEL_PATH = Path("unbalanced_disk_zip_models/a2c_unbalanced_disk_noise_omega_04")
OBS_NOISE_OMEGA = 0.4 # rad/s std dev added to obs[2] during sim training/evaluation
REWARD_WEIGHTS = {
    "swing_up": 0.5,
    "capture": 12.0,
